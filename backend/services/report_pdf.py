...
# Standard liability / limitation disclosure appended to every generated
# report. Heuristic thresholds are not clinically validated; this is a
# screening aid, not a medical device or a professional ergonomic assessment.
_DISCLAIMER_HTML = """
<div class="disclosure" style="margin-top:28px;">
  <strong>Important notice</strong> &mdash; This report is generated by ErgoVigilance
  using heuristic posture-risk thresholds that have been calibrated against a
  labeled REBA dataset but are <strong>not clinically validated</strong>. It is a
  screening and awareness tool, <strong>not a medical device</strong>, and does not
  constitute a professional ergonomic assessment by a certified ergonomist,
  physical therapist, or occupational-health professional. Risk scores are
  estimates for prioritization only and do not establish causation of injury.
  Video and derived data were processed on-site; no footage is uploaded to the
  cloud. Thresholds may be tuned by a qualified professional before acting on
  this report.
</div>
"""
